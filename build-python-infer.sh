#!/bin/bash
#SBATCH --job-name=python-ml-infer
#SBATCH --ntasks=1
...
apptainer build --fakeroot /tmp/$USER/ml-infer_01.00.sif \
docker://aleitocu/ml_infer:01.00

mv /tmp/$USER/ml-infer_01.00.sif $VSC_SCRATCH
...
# Run image
apptainer instance start ml-infer_01.00.sif ml_infer_instance
apptainer instanace list

# Sleep again to check container running
echo "Container running, going to sleep for 1 minute"
sleep 60
